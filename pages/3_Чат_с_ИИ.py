...
def response_func(prompt, text):
    ...
    with get_openai_callback() as cb:
        result = chain.run(input_documents=docs, question=prompt, max_tokens_limit=500)
        st.write(result)
    return result
        ...
        if chat_names:
            ...
            if st.session_state.selected_chat_name:
                ...
                if selected_chat_data:
                    ...
                    2. Формат:
                       - Формат A4, поля: слева - 30 мм, справа - 15 мм, сверху - 20 мм, снизу - 20 мм.
                       - Шрифт: Times New Roman, кегль 12 pt.
                       - Межстрочный интервал: полуторный.
                    
                    3. Нумерация страниц:
                       - Все страницы, кроме титульной, пронумерованы.
                       - Номера страниц ставятся внизу по центру.
                    
                    4. Заголовки:
                       - Заголовки структурных элементов выделяются полужирным шрифтом.
                       - Уровень заголовка:
                         - Основные заголовки (1-й уровень): кегль 14 pt, полужирный.
                         - Подзаголовки (2-й уровень): кегль 12 pt, полужирный.
                         - Подразделы (3-й уровень): кегль 12 pt, курсив.
