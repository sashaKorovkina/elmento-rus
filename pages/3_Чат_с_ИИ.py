            ...
            if st.session_state.selected_chat_name:
                ...
                if selected_chat_data:
                    ...
                    if selected_question_type == "Структура научной статьи по ГОСТ":
                        selected_question_type = f'''
                        "Напишите эссе по ГОСТу, содержание не более 1000 токенов:
                            Титульная страница:
                            Заголовок (ГОСТ 7.1-2003).
                            ФИО авторов и их место работы.
                            Контактная информация авторов.
                            Аннотация (ГОСТ 7.9-95):
                            150-250 слов.
                            Основные аспекты: область, цель, методы, результаты, выводы.
                            Ключевые слова (ГОСТ 7.9-95):
                            5-10 словосочетаний.
                            Введение:
                            Проблема, актуальность, цели и задачи.
                            Материалы и методы (ГОСТ 7.32-2017):
                            Подробное описание материалов и методов.
                            Результаты и обсуждение:
                            Основные результаты, сравнение, интерпретация.
                            Заключение:
                            Подведение итогов, практическая значимость, перспективы.
                            Список литературы (ГОСТ 7.1-2003, ГОСТ 7.0.5-2008):
                            Минимум 10 источников, форматирование по ГОСТу."
                    '''
