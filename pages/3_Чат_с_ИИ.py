            ...
            if st.session_state.selected_chat_name:
                ...
                if selected_chat_data:
                    ...
                    if selected_question_type == "Структура курсовой работы по ГОСТ":
                        selected_question_type = f'''Write an essay about the file you have in Russian following this format and keep it under 1000 tokens: 
                        1. Титульный лист:
                        ...
                        8. Список литературы (ГОСТ 7.1-2003, ГОСТ 7.0.5-2008):
                           - Оформляется в соответствии с ГОСТ 7.0.5-2008.
                           - Источники располагаются в порядке появления в тексте или в алфавитном порядке.
                           - Объем: минимум 15 источников.
                           - Примеры оформления:
                             - Книга:
                               ```markdown
                               Иванов И.И. Основы программирования. – Москва: Наука, 2020. – 300 с.
                               ```
                             - Статья:
                               ```markdown
                               Петров П.П. Математическое моделирование // Математика и информатика. – 2019. – №5. – С. 20-25.
                               ```
                             - Интернет-источник:
                               ```markdown
                               Сидоров С.С. Алгоритмы и структуры данных [Электронный ресурс] // Образовательный портал. – URL: http://www.example.com/algorithms (дата обращения: 09.05.2024).
                               ```
                        
                        9. Приложения: 
                          - Размещаются после списка литературы.
                           - Каждый элемент приложения начинается с новой страницы и имеет заголовок.
                           - Нумерация приложений сквозная (Приложение А, Приложение Б и т. д.).
                           - Примеры приложений:
                             - Таблицы, диаграммы, графики.
                             - Программы, алгоритмы, коды.
                             - Тексты опросников, анкет.
                    '''
                        # st.write(f"Вы выбрали тип вопроса: {selected_question_type}")
                        chat_id = selected_chat_data['chat_id']
                        with st.chat_message("user"):
